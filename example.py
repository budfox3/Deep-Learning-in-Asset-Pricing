...
load data
Z   = np.loadtxt('/my_data/realZ_sample.txt')
R1  = np.loadtxt('/my_data/realstock_return.txt')
R2  = np.loadtxt('/my_data/realportfolio_return.txt')
M   = np.loadtxt('/my_data/realMKT.txt')
